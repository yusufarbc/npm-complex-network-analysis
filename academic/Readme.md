...
- **Yazarlar:** Pongchai Jaisri; Reid, Brittany; Kula, Raula Gaikovina
- **Yıl:** 2024
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/preliminary-study-on-self-contained-libraries-npm/docview/3069347774/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **A Preliminary Study on Self-Contained Libraries in the NPM Ecosystem** konusuna odaklanır. Anahtar odaklar: Software Engineering.
...
- **Keywords:** Graph matching , Software Bill of Materials , Software composition analysis , Software supply chain security , x86 disassembly
- **URL:** https://www.proquest.com/dissertations-theses/accurate-efficient-sbom-generation-software/docview/3119435842/se-2?accountid=25087
...
- **Yazarlar:** Yu, Sheng
- **Yıl:** 2024
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Graph matching , Software Bill of Materials , Software composition analysis , Software supply chain security , x86 disassembly
- **Bağlantı:** https://www.proquest.com/dissertations-theses/accurate-efficient-sbom-generation-software/docview/3119435842/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Accurate and Efficient SBOM Generation for Software Supply Chain Security** konusuna odaklanır. Anahtar odaklar: Graph matching , Software Bill of Materials , Software composition analysis , Software supply chain security , x86 disassembly.
...
- **Yazarlar:** Ohm, Marc; Plate, Henrik; Arnold Sykosch; Meier, Michael
- **Yıl:** 2020
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/backstabbers-knife-collection-review-open-source/docview/2405057286/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Backstabber's Knife Collection: A Review of Open Source Software Supply Chain Attacks** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Software Engineering.
...
- **Yazarlar:** Rahman, Imranur; Zahan, Nusrat; Magill, Stephen; Enck, William; Williams, Laurie
- **Yıl:** 2024
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Software Engineering , Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/characterizing-dependency-update-practice-npm/docview/3000390682/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Characterizing Dependency Update Practice of NPM, PyPI and Cargo Packages** konusuna odaklanır. Anahtar odaklar: Software Engineering , Cryptography and Security.
...
- **Yazarlar:** Hastings, Thomas G.
- **Yıl:** 2024
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Software projects , Supply chain attacks , Web browser , Package managers
- **Bağlantı:** https://www.proquest.com/dissertations-theses/combating-source-poisoning-next-generation/docview/3042954782/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Combating Source Poisoning and Next-Generation Software Supply Chain Attacks Using Education, Tools, and Techniques** konusuna odaklanır. Anahtar odaklar: Software projects , Supply chain attacks , Web browser , Package managers.
...
- **Yazarlar:** Wang, Maoyang; Wu, Peng; Luo, Qin
- **Yıl:** 2023
- **Tür:** Scholarly Journals
- **Anahtar Kelimeler:** software supply chain , Supply chain , Software industry , Threat model , software supply chain threat model , attack technique matrix , software supply chain portrait
- **Bağlantı:** https://www.proquest.com/scholarly-journals/construction-software-supply-chain-threat/docview/2899423524/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Construction of Software Supply Chain Threat Portrait Based on Chain Perspective** konusuna odaklanır. Anahtar odaklar: software supply chain , Supply chain , Software industry , Threat model , software supply chain threat model , attack technique matrix , software supply chain portrait.
...
- **Authors:** Liu, Chengwei; Chen, Sen; Fan, Lingling; Chen, Bihuan; Liu, Yang; Peng, Xin
- **Year:** 2022
- **Type:** Working Papers
- **Keywords:** Software Engineering
- **URL:** https://www.proquest.com/working-papers/demystifying-vulnerability-propagation-evolution/docview/2619058800/se-2?accountid=25087
- **Database:** Publicly Available Content Database
...
- **Yazarlar:** Liu, Chengwei; Chen, Sen; Fan, Lingling; Chen, Bihuan; Liu, Yang; Peng, Xin
- **Yıl:** 2022
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/demystifying-vulnerability-propagation-evolution/docview/2619058800/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Demystifying the Vulnerability Propagation and Its Evolution via Dependency Trees in the NPM Ecosystem** konusuna odaklanır. Anahtar odaklar: Software Engineering.
...
- **Yazarlar:** Liu, C., Chen, S., et al.
- **Yıl:** 2022
- **Tür:** Konferans (ICSE 2022)
- **Anahtar Kelimeler:** Vulnerability propagation, Dependency trees, Knowledge graph, Security

**Kısa Açıklama (TR):** Bu çalışma **Demystifying Vulnerability Propagation via Dependency Trees in npm** konusuna odaklanır. Anahtar odaklar: Vulnerability propagation, Dependency trees, Knowledge graph, Security.
...
- **Yazarlar:** Correia, Miguel Luís Pereira
- **Yıl:** 2022
- **Tür:** Dissertations & Theses
- **Bağlantı:** https://www.proquest.com/dissertations-theses/detection-software-supply-chain-attacks-code/docview/3110429026/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Detection of Software Supply Chain Attacks in Code Repositories** konusuna odaklanır.
...
- **Authors:** Lew, Ken; Sarker, Arijet; Wuthier, Simeon; Kim, Jinoh; Kim, Jonghyun; Sang-Yoon, Chang
- **Year:** 2024
- **Type:** Scholarly Journals
- **Keywords:** software supply chain , assurance , software integrity , applied cryptography , blockchain
- **URL:** https://www.proquest.com/scholarly-journals/distributed-software-build-assurance-supply-chain/docview/3120540867/se-2?accountid=25087
- **Database:** Publicly Available Content Database
...
- **Yazarlar:** Lew, Ken; Sarker, Arijet; Wuthier, Simeon; Kim, Jinoh; Kim, Jonghyun; Sang-Yoon, Chang
- **Yıl:** 2024
- **Tür:** Scholarly Journals
- **Anahtar Kelimeler:** software supply chain , assurance , software integrity , applied cryptography , blockchain
- **Bağlantı:** https://www.proquest.com/scholarly-journals/distributed-software-build-assurance-supply-chain/docview/3120540867/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Distributed Software Build Assurance for Software Supply Chain Integrity** konusuna odaklanır. Anahtar odaklar: software supply chain , assurance , software integrity , applied cryptography , blockchain.
...
- **Yazarlar:** Kang Yip, Danny Yi
- **Yıl:** 2022
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Dependency , Discord , Malicious module , Node.js , Prototype Pollution , Vulnerabilities
- **Bağlantı:** https://www.proquest.com/dissertations-theses/empirical-study-on-exploitation-dependency-based/docview/2674421314/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Empirical Study on Exploitation of Dependency-Based Attacks in Node.Js** konusuna odaklanır. Anahtar odaklar: Dependency , Discord , Malicious module , Node.js , Prototype Pollution , Vulnerabilities.
...
- **Yazarlar:** Torres-Arias, Santiago
- **Yıl:** 2020
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Continuous delivery , Cryptography , Security , Software supply chain
- **Bağlantı:** https://www.proquest.com/dissertations-theses/toto-practical-software-supply-chain-security/docview/2427238266/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global, Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **In-toto: Practical Software Supply Chain Security** konusuna odaklanır. Anahtar odaklar: Continuous delivery , Cryptography , Security , Software supply chain.
...
- **Yazarlar:** Zhang, Junan; Huang, Kaifeng; Chen, Bihuan; Wang, Chong; Tian, Zhenhao; Peng, Xin
- **Yıl:** 2023
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/malicious-package-detection-npm-pypi-using-single/docview/2861990120/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Malicious Package Detection in NPM and PyPI using a Single Model of Malicious Behavior Sequence** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Software Engineering.
...
- **Yazarlar:** Halder, S; Bewong, M; Mahboubi, A; Jiang, Y; Islam, R; Islam, Z; R Ip; Ahmed, E; Ramachandran, G; Babar, A
- **Yıl:** 2024
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/malicious-package-detection-using-metadata/docview/2925761843/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Malicious Package Detection using Metadata Information** konusuna odaklanır. Anahtar odaklar: Cryptography and Security.
...
- **Yazarlar:** Hafner, Andrej; Mur, Anže; Jaka Bernard
- **Yıl:** 2021
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Social and Information Networks
- **Bağlantı:** https://www.proquest.com/working-papers/node-package-managers-dependency-network/docview/2585639033/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Node package manager's dependency network robustness** konusuna odaklanır. Anahtar odaklar: Social and Information Networks.
...
- **Yazarlar:** Ladisa, Piergiorgio; Ponta, Serena Elisa; Ronzoni, Nicola; Martinez, Matias; Barais, Olivier
- **Yıl:** 2023
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/on-feasibility-cross-language-detection-malicious/docview/2878367596/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **On the Feasibility of Cross-Language Detection of Malicious Packages in npm and PyPI** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Software Engineering.
...
- **Yazarlar:** Zerouali, Ahmed; Mens, Tom; Decan, Alexandre; Coen De Roover
- **Yıl:** 2022
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/on-impact-security-vulnerabilities-npm-rubygems/docview/2541122103/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **On the Impact of Security Vulnerabilities in the npm and RubyGems Dependency Networks** konusuna odaklanır. Anahtar odaklar: Software Engineering.
...
- **Authors:** Decan, A., Mens, T., et al.
- **Year:** 2018
- **Type:** Konferans (MSR 2018)
- **Keywords:** Software repository mining, Security vulnerability, Dependency network, Semantic versioning
...
- **Yazarlar:** Decan, A., Mens, T., et al.
- **Yıl:** 2018
- **Tür:** Konferans (MSR 2018)
- **Anahtar Kelimeler:** Software repository mining, Security vulnerability, Dependency network, Semantic versioning

**Kısa Açıklama (TR):** Bu çalışma **On the Impact of Security Vulnerabilities in the npm Dependency Network** konusuna odaklanır. Anahtar odaklar: Software repository mining, Security vulnerability, Dependency network, Semantic versioning.
...
- **Yazarlar:** Sejfia, Adriana; Schäfer, Max
- **Yıl:** 2022
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/practical-automated-detection-malicious-npm/docview/2634669530/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Practical Automated Detection of Malicious npm Packages** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Software Engineering.
...
- **Yazarlar:** Zimmermann, Markus; Cristian-Alexandru Staicu; Tenny, Cam; Pradel, Michael
- **Yıl:** 2019
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/small-world-with-high-risks-study-security/docview/2185999630/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Small World with High Risks: A Study of Security Threats in the npm Ecosystem** konusuna odaklanır. Anahtar odaklar: Cryptography and Security.
...
- **Yazarlar:** Schorlemmer, Taylor R.
- **Yıl:** 2024
- **Tür:** Dissertations & Theses
- **Bağlantı:** https://www.proquest.com/dissertations-theses/software-supply-chain-security-attacks-defenses/docview/3122639657/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Software Supply Chain Security: Attacks, Defenses, And the Adoption of Signatures** konusuna odaklanır.
...
- **Yazarlar:** Cogo, Filipe Roseiro
- **Yıl:** 2020
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Open source software
- **Bağlantı:** https://www.proquest.com/dissertations-theses/studying-dependency-maintenance-practices-through/docview/2524882679/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Studying Dependency Maintenance Practices Through the Mining of Data from NPM Packages** konusuna odaklanır. Anahtar odaklar: Open source software.
...
- **Yazarlar:** Ohm, Marc; Kempf, Lukas; Boes, Felix; Meier, Michael
- **Yıl:** 2021
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/supporting-detection-software-supply-chain/docview/2457813215/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Supporting the Detection of Software Supply Chain Attacks through Unsupervised Signature Generation** konusuna odaklanır. Anahtar odaklar: Cryptography and Security.
...
- **Yazarlar:** Ladisa, Piergiorgio; Sahin, Merve; Ponta, Serena Elisa; Rosa, Marco; Martinez, Matias; Barais, Olivier
- **Yıl:** 2023
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/hitchhikers-guide-malicious-third-party/docview/2839581173/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **The Hitchhiker's Guide to Malicious Third-Party Dependencies** konusuna odaklanır. Anahtar odaklar: Cryptography and Security.
...
- **Yazarlar:** Emilie-Rose Oldnall
- **Yıl:** 2017
- **Tür:** Tez (Yüksek Lisans Tezi)

**Kısa Açıklama (TR):** Bu çalışma **The Web of Dependencies: A Complex Network Analysis of the NPM** konusuna odaklanır.
...
- **Yazarlar:** Imtiaz, Nasif
- **Yıl:** 2023
- **Tür:** Dissertations & Theses
- **Bağlantı:** https://www.proquest.com/dissertations-theses/toward-secure-use-open-source-dependencies/docview/2890690575/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Toward Secure Use of Open Source Dependencies** konusuna odaklanır.
...
- **Yazarlar:** Vaidya, Sangat
- **Yıl:** 2022
- **Tür:** Dissertations & Theses
- **Anahtar Kelimeler:** Code management , Software distribution , Software repositories , Software security , Software supply chain
- **Bağlantı:** https://www.proquest.com/dissertations-theses/towards-ensuring-integrity-authenticity-software/docview/3099364373/se-2?accountid=25087
- **Veritabanı:** ProQuest Dissertations & Theses Global

**Kısa Açıklama (TR):** Bu çalışma **Towards Ensuring Integrity and Authenticity of Software Repositories** konusuna odaklanır. Anahtar odaklar: Code management , Software distribution , Software repositories , Software security , Software supply chain.
...
- **Yazarlar:** Duan, Ruian; Alrawi, Omar; Ranjita Pai Kasturi; Elder, Ryan; Saltaformaggio, Brendan; Lee, Wenke
- **Yıl:** 2020
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security
- **Bağlantı:** https://www.proquest.com/working-papers/towards-measuring-supply-chain-attacks-on-package/docview/2351269484/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Towards Measuring Supply Chain Attacks on Package Managers for Interpreted Languages** konusuna odaklanır. Anahtar odaklar: Cryptography and Security.
...
- **Yazarlar:** Zheng, Xinyi; Chen, Wei; Wang, Shenao; Zhao, Yanjie; Gao, Peiming; Zhang, Yuanchao; Wang, Kailong; Wang, Haoyu
- **Yıl:** 2024
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/towards-robust-detection-open-source-software/docview/3106232107/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **Towards Robust Detection of Open Source Software Supply Chain Poisoning Attacks in Industry Environments** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Software Engineering.
...
- **Authors:** Zahan, Nusrat; Zimmermann, Thomas; Godefroid, Patrice; Murphy, Brendan; Maddila, Chandra; Williams, Laurie
- **Year:** 2022
- **Type:** Working Papers
- **Keywords:** Cryptography and Security , Computers and Society , Software Engineering
- **URL:** https://www.proquest.com/working-papers/what-are-weak-links-npm-supply-chain/docview/2612219742/se-2?accountid=25087
- **Database:** Publicly Available Content Database
...
- **Yazarlar:** Zahan, Nusrat; Zimmermann, Thomas; Godefroid, Patrice; Murphy, Brendan; Maddila, Chandra; Williams, Laurie
- **Yıl:** 2022
- **Tür:** Working Papers
- **Anahtar Kelimeler:** Cryptography and Security , Computers and Society , Software Engineering
- **Bağlantı:** https://www.proquest.com/working-papers/what-are-weak-links-npm-supply-chain/docview/2612219742/se-2?accountid=25087
- **Veritabanı:** Publicly Available Content Database

**Kısa Açıklama (TR):** Bu çalışma **What are Weak Links in the npm Supply Chain?** konusuna odaklanır. Anahtar odaklar: Cryptography and Security , Computers and Society , Software Engineering.
