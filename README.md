...
## Supply Chain Saldırısı Özeti (Eylül 2025)
...
10. **Reddit (r/programming)**: Topluluk tartışması; bakıcı açıklaması. Link: https://www.reddit.com/r/programming/comments/1nbqt4d/largest-npm-compromise-in-history-supply-chain/. Alıntı: "NPM bakıcısı: 'Pwned oldum'; saldırı phishing ile başladı."
