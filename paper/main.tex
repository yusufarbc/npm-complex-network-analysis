...
\usepackage{xcolor}
% Dosya var-yok kontrolünü results/ için de yapacak şekilde sarmalayıcı
\let\OrigIfFileExists\IfFileExists
\renewcommand{\IfFileExists}[3]{%
  \OrigIfFileExists{#1}{#2}{%
    \OrigIfFileExists{../results/#1}{#2}{#3}%
  }%
}
